...
const Footer = () => {
  // Share links and the video player are client-facing views; no newsletter signup there.
  const hideNewsletter = /^\/(shared|watch)\b/.test(usePathname());
            ...
            <div className="relative z-10 flex flex-col justify-between gap-x-10 gap-y-8 md:flex-row md:items-end">
              <div className="max-w-[442px]">
                ...
                <small className="mt-3 text-sm leading-5 tracking-sm text-[rgba(255,255,255,0.70)]">
                  Stay connected with EdventureHub — receive curated learning
              ...
              <div className="w-full max-w-[400px]">
                <form className="relative flex items-center">
                  <Input
                    required
                    placeholder="hello@edventurehub.com"
